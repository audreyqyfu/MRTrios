...
#'
#' @return a dataframe with 19 columns:
#' @return IlmnID
...
#' @export
#'
#' @seealso [findTrioAll()] [addDupsCNA], [addDupsGENE()] [findPCs()] [analyzeTrios()]
#'
#' @examples probe_info_data = HumanMethProbeInfo(df, "M1.1", meth, gene, cna, final.trios.df, humanmeth, biomart, 5, 3, 3, clinical.pos)
#' @examples probe_info_data
#'
